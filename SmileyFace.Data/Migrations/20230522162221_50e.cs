...
{
    /// <inheritdoc />
    public partial class _50e : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdeaChainId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmojiPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmojiPositions_IdeaChains_IdeaChainId",
                        column: x => x.IdeaChainId,
                        principalTable: "IdeaChains",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmojiPositions_IdeaChainId",
